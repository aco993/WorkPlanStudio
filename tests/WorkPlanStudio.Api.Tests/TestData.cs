...
internal static class TestData
{
    ...
    public static WorkCenterDto NewCenter(string code) =>
        new(0, code, $"Test center {code}", "CC-0001", 50m, 1, "one-shift", true, "");
    ...
    public static ProductionOrderDto NewOrder(string orderNumber, int workPlanId, int quantity = 10) =>
        new(
            ...
            null,
            quantity,
            ReleaseUtc: new DateTime(2026, 6, 1, 6, 0, 0, DateTimeKind.Utc),
            DueUtc: new DateTime(2026, 6, 8, 6, 0, 0, DateTimeKind.Utc),
            Priority: 2,
            Status: 0,
            RoutingRevision: "",
            RoutingSnapshotJson: "",
