...
public sealed class GanttAccessibilityTests : BunitContext
{
    ...
    /// </summary>
    [Fact]
    public void The_chart_is_one_tab_stop_and_the_arrow_keys_move_it()
    {
        Arrange(WithClosedTime());
        ...
        Focused(cut).KeyDown("ArrowRight");
    ...
    [Fact]
    public void Arrow_down_moves_to_the_next_work_center_and_arrow_up_comes_back()
    {
        Arrange(WithClosedTime());
    ...
    [Fact]
    public void End_and_Home_jump_to_the_ends_of_the_lane()
    {
        Arrange(WithClosedTime());
    ...
    /// </summary>
    [Fact]
    public void Activating_a_mark_writes_its_explanation_into_a_live_region_that_already_existed()
    {
        Arrange(WithClosedTime());
    ...
    [Fact]
    public void Escape_clears_the_explanation()
    {
        Arrange(WithClosedTime());
        ...
        cut.Find(".gantt-closed").KeyDown("Escape");
    ...
    [Fact]
    public void The_text_equivalent_can_be_shown_on_screen_and_says_so()
    {
        Arrange(WithClosedTime());
        ...
        cut.Find(".gantt-table-toggle").Click();
