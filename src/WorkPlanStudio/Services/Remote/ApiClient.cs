...
public sealed class ApiClient
{
    ...
    /// <summary>Every cost center.</summary>
    /// <param name="cancellationToken">Cancels the call.</param>
    public Task<IReadOnlyList<CostCenterDto>> GetCostCentersAsync(CancellationToken cancellationToken = default) =>
        GetListAsync<CostCenterDto>("api/cost-centers", cancellationToken);
