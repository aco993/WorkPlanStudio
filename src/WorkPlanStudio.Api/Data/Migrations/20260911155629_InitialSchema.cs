    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                ...
                table.CheckConstraint("CK_WorkCenter_CostCenter", "length(CostCenter) <= 20");
                table.CheckConstraint("CK_WorkCenter_HourlyRate", "HourlyRate >= 0 AND HourlyRate <= 1000000");
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                TimePerPieceMinutes = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.CheckConstraint("CK_Operation_RunTime", "TimePerPieceMinutes >= 0 AND TimePerPieceMinutes <= 1000000");
                table.CheckConstraint("CK_Operation_SetupTime", "SetupTimeMinutes >= 0 AND SetupTimeMinutes <= 1000000");
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Status = table.Column<int>(type: "INTEGER", nullable: false),
                RoutingRevision = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false),
            ...
            constraints: table =>
            {
                ...
                table.CheckConstraint("CK_ProductionOrder_Quantity", "Quantity >= 1");
                table.ForeignKey(
